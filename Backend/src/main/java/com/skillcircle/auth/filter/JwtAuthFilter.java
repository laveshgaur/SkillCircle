 ...
 *
 * Only processes access tokens (type="access"). Refresh tokens are handled
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            // Don't propagate — let the request continue as unauthenticated
        }
